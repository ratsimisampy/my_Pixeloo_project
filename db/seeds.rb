...
#  1.times do |user|
 ...
 # end
  ...
  items = Item.create!(title: "canon eos-6d", description: a, price: "40", user_id: "1", category_id: "1", address: '19 rue Saint Roch 75001 PARIS', city: "Paris")
  ...
  items = Item.create!(title: "canon eos-650", description: b, price: "35", user_id: "1", category_id: "1", address: '14 rue Saint Roch 75001 PARIS', city: "Paris")
  ...
  items = Item.create!(title: "lumix 45-200", description: f, price: "20", user_id: "1", category_id: "3", address: '24 rue Saint Roch 75001 PARIS', city: "Paris")
   items.item_image.attach(io: File.open('app/assets/images/objectif/lumix-45-200.png'), filename: 'lumix-45-200.png', content_type: 'image/png')
  ...
  items = Item.create!(title: "ISO kit d'éclairage continu 1 Mandarine 800W + 1 pied + coupe flux", description: h, price: "15", user_id: "1", category_id: "2", address: '4 Place du Louvres 75001 PARIS', city: "Paris")
   items.item_image.attach(io: File.open('app/assets/images/eclairage/mandarine.jpg'), filename: 'mandarine.jpg', content_type: 'image/jpg')
  ...
  items = Item.create!(title: "canon speedlite-430", description: g, price: "20", user_id: "1", category_id: "2", address: '125 bis rue d Avron 75020 PARIS', city: "Paris")
   items.item_image.attach(io: File.open('app/assets/images/eclairage/canon-speedlite-430.png'), filename: 'canon-speedlite-430.png', content_type: 'image/png')
  ...
  items = Item.create!(title: "canon speedlite-600", description: g, price: "30", user_id: "1", category_id: "2", address: '5 Boulevard Diderot 75012 PARIS', city: "Paris")
   items.item_image.attach(io: File.open('app/assets/images/eclairage/canon-speedlite-600.png'), filename: 'canon-speedlite-600.png', content_type: 'image/png')
